...
function App() {
  ...
  return (
    <div className="wrapper">
      {isOpen ? <Drawer onMinus={deleteItem} items={drawerItems} onClick={() => setOpen(false)} /> : null}
          ...
          <div className="container">
            ...
            <div className="catalog__inner">
              {catalog
                ...
                .map((item) => (
                  <Card onPlus={ addToCart } id={item.id} name={item.name} price={item.price} img={item.img} />
